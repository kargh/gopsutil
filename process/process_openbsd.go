...
import (
	...
	cpu "github.com/kargh/gopsutil/v3/cpu"
	"github.com/kargh/gopsutil/v3/internal/common"
	mem "github.com/kargh/gopsutil/v3/mem"
	net "github.com/kargh/gopsutil/v3/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/kargh/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
